...
var knifeImage , fruit1, fruit2 ,fruit3,fruit4, monsterImage
var gameOverImage,gameO
var soundK,soundGO
...
function preload(){
  ...
  soundK = loadSound("knifeSwoosh.mp3")
...
function setup() {
  ...
  gameOverImage=createSprite(40,40)
gameOverImage.addImage(gameO);

  gameOverImage.scale=2.5
  gameOverImage.y=400
  gameOverImage.x=300
